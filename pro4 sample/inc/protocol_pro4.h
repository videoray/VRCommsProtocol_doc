...
#include <types.h>
#include <protocol_pro4_device_types.h>
...
/** Explicit size of protocol header
  ...
  */
#define PROTOCOL_PRO4_HEADER_SIZE 7u

/** Maximum Payload size of a request packet */
#define MAX_RESQUEST_SIZE 255u
...
#define PROTOCOL_PRO4_DATA_PAYLOAD_START_INDEX  7u
#define PROTOCOL_PRO4_REQUEST_DATA_PAYLOAD_START_INDEX  7u
#define PROTOCOL_PRO4_RESPONSE_DATA_PAYLOAD_START_INDEX 8u
/*@}*/
...
/**
 *  @name Marcos and defines for Device ID byte 
 */
/*@{*/
...
#define REQUEST_ID_CODE  0x4449
//* ID code byte 1 */
#define REQUEST_ID_CODE_1 0x49 //ASCII 'I'
//* ID code byte 2 */
#define REQUEST_ID_CODE_2 0x44 //ASCII 'D'

#define BROADCAST_ID_CODE  0x4942
//* Broadcast ID code byte 1 */
#define BROADCAST_ID_CODE_1  0x42 //ASCII 'B'
//* Broadcast ID code byte 2 */
#define BROADCAST_ID_CODE_2 0x49 //ASCII 'I'
 ...
 *  @return XOR checksum  
 */
uint8_t protocol_pro4_checksum(uint8_t* buf, int len);
 ...
 */
unsigned int protocol_pro4_parse(uint8_t data,
                                 uint8_t* packet_buf, 
 ...
 *
 *   protocol_pro4_Hooks_NOP.c provides a skeleton implementation
 */
/*@{*/
 ...
 */
void protocol_pro4_csr_write(int addr,  int len, uint8_t *buf);
...
bool protocol_pro4_accept_id(uint8_t id, bool isResponse);
 ...
 *
 */
 bool protocol_pro4_relay_packet(uint8_t* data);
/*@}*/                                        

/*@}*/

void protocol_pro4_handler(Protocol_PRO4_Packet_Header *header, uint8_t* data);
